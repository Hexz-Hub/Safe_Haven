...
<head>
    ...
    <style>
        ...
        .hero {
            ...
            position: relative;
            overflow: hidden;
            background: linear-gradient(rgba(75, 44, 107, 0.55), rgba(45, 27, 71, 0.5)),
        ...
        .intro {
            padding: 100px 0;
            background: linear-gradient(135deg, rgba(75, 44, 107, 0.95), rgba(45, 27, 71, 0.9)),
    ...
    <section class="intro">
        <div class="container">
            <div class="intro-glass-card animate">
                ...
                <blockquote>
                    "Unlike traditional brokers who sell potential, we sell verified reality. We combine deep Delta State market knowledge with a proprietary verification process. If it isn't safe enough for our own family, it doesn't make it into our SafeHaven."
                </blockquote>
            </div>
        </div>
    </section>
    ...
    <section class="why-us">
        <div class="container">
            ...
            <div class="why-us-grid">
                ...
                <div class="why-card animate">
                    <span class="why-icon">🔦</span>
                    <h3>The SafeHaven Standard</h3>
                    <p>Our SafeHaven Standard isn't just a promise—it's a guarantee of certainty, a rigorous process that ensures any land or building we recommend is legally bulletproof and truly safe.</p>
                </div>
                <div class="why-card animate">
                    <span class="why-icon">🧠</span>
    ...
    <section class="listings" id="listings">
        <div class="container">
            <div class="section-title animate">
                ...
                <p>Explore our carefully selected properties that have passed the SafeHaven verification process.</p>
            </div>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    <a href="#" class="footer-logo">SAFEHAVEN</a>
